...
router.post('/admin-categories', adminCategoryController_1.AdmincreateCategory);
router.get('/admin-categories', adminCategoryController_1.AdmingetCategories);
router.put('/admin-categories/:id', adminCategoryController_1.AdminupdateCategory);
router.delete('/admin-categories/:id', adminCategoryController_1.AdmindeleteCategory);
